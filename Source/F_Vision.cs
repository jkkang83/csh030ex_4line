...
namespace CSH030Ex
{
    public partial class FVision : Form
    {
        ...
        public void ManualFindMarks(int Nth, bool IsShowResult = true, bool fromFirst = false)
        {
            ...
            File.AppendAllLines("D:\\PIE Repeatability\\TimeStability.csv", new[] { strtmp[0] });
...
                lrc.X = (int)(m__G.oCam[0].mDetectedMarkPos[0][1].X * m__G.oCam[0].mFAL.mModelScale + 39 + 13);
        ...
        private void btnAgingXYZ_Click(object sender, EventArgs e)
        {
            double x = double.Parse(tbXrange.Text);
            double y = double.Parse(tbYrange.Text);
            double z = double.Parse(tbZrange.Text);
            ...
            //for (int i = 0; i < 20; i++)
            //{
            //    MotorXYZ(orgPos[0],  y + orgPos[1], orgPos[2]);
            //    MotorXYZ(orgPos[0], -y + orgPos[1], orgPos[2]);
            //}
            //MotorXYZ(orgPos[0], orgPos[1], orgPos[2]);
            //for (int i = 0; i < 20; i++)
            //{
            //    MotorXYZ(orgPos[0],orgPos[1],  z + orgPos[2]);
            //    MotorXYZ(orgPos[0],orgPos[1], -z + orgPos[2]);
            //}
            MotorXYZ(orgPos[0], orgPos[1], orgPos[2]);
        ...
        private void btnGlassCal_Click(object sender, EventArgs e)
        {
            cboAxis.SelectedItem = Axis.X;
            RunScanTest();

            cboAxis.SelectedItem = Axis.Y;
            RunScanTest();
