...
#if DEBUG_MODE
    #define USE_Probe_Glass_CalMode
#endif
...
//#endif
        ...
        //***********************************//
        public double[] ReadPortAll(bool skip1 = false, bool skip2 = false, bool skip3 = false, bool skip4 = false, bool skip5 = false, bool skip6 = false, bool skip7 = false)
        {
            int signX = 1;
            int signY = -1;
            int signTZ1 = -1;
            ...
            // 251223 마크 Plate 교체
            double XtoTX = 0.00015344; //0.00075;//= 0.0003;                   // = -0.000313915;
            double XtoTY1 = -0.000938849; //-0.00056;//= -0.0006;                   // = -0.001537063;  //  -0.000014
            double XtoTY2 = -0.000324663; //0.00019;//= 0.0000;                    // = 0.000071590;   //  +0.000014 
            double YtoTX = 0.003126288;  //0.00354;//=  0.0040;                    // = 0.003107188; 
            double YtoTY1 = -0.00039684; // -0.00045;//= 0.00005;                    // = 0.000034151; 
            double YtoTY2 = 0.00087765;  // 0.00127;//= 0.0016;                    // = 0.000835260; 
            ...
            res[6] = res[6] - XtoTY2 * (res[0] - (1-Math.Cos(ltz)) *60000) - YtoTY2 * (res[1] - Math.Sin(ltz) * 60000);  //  (-,+) TY1 relative to TY2 따라서 120000 이 맞음 -> TY Cal 에 영향, 식변경 시 Cal 다시할 것 2.5
                                                                                                                         //#if USE_Probe_Glass_CalMode
            probe_glass_compensation_value[0] = res[0];   //  X
            probe_glass_compensation_value[1] = res[1];   //  Y
            probe_glass_compensation_value[2] = res[2];   //  TZ1
            probe_glass_compensation_value[3] = res[3];   //  TZ2
            probe_glass_compensation_value[4] = res[4];   //  TX      -> Z2
            probe_glass_compensation_value[5] = res[5];   //  TY1     -> Z1
            probe_glass_compensation_value[6] = res[6];   //  TY2     -> Z3
